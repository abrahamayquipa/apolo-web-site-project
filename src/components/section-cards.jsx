...
function SectionCards() {
    return(
        <article id="cards" className="margin--sides margin--section-cards">
            <section className="grid-layout">
                <h2 className="section-cards-layout__content font--regular-big-bold">¿Cómo funciona?</h2>
                <span className="section-cards-layout__content font--regular-dark-gray">Hacemos uso de sensores de nivel de ruido que facilitan las tareas de monitoreo</span>
            </section>
            <section className="grid-layout">
                <div className="section-cards-layout__cards flexbox-layout">
